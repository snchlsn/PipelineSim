//Original author: Chester Ragel
//Modified by Seth Nicholson
...
namespace FormsExtensions
{
	...
	public class OrientedTextLabel: Label
	{
		...
		private string text;
		private OrientedTextStyle textOrientation;
		...
		public OrientedTextLabel()
		{
			...
			rotationAngle = 0d;
			textOrientation = OrientedTextStyle.Rotate;
		...
		public OrientedTextStyle TextOrientation
		{
			get
			{
